...
#pragma HLS array_partition variable=a_buf_normal block factor=1
#pragma HLS array_partition variable=b_buf_normal block factor=1
    int c_buf_normal[DATA_SIZE];
#pragma HLS array_partition variable=c_buf_normal block factor=1
